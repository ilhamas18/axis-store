...
const EwalletEsim = () => {
  ...
  const CancelReserveSync = async () => {
    ...
    if (response?.status == 200) {
      router.push("/pembayaran-esim/ewallet-gopay/timeout");
  ...
  return (
    <div className="container">
      <SEO title={"Pembayaran Esim E-Wallet Gopay"} />
      {/* <iframe
          ...
          {checkDevice() == "Browser" && (
            <div className="py-5">
              <div className="card-payment-info flex flex-col justify-center items-center">
                <h3 className="leading-5 text-center">
                  Buka aplikasi Gojek dan scan QR Code dibawah ini.
                </h3>
                <Image
                  src={payment.wallet.qr_code}
                  width={200}
                  height={200}
                  alt="QR Code"
                />
              ...
              <Link href={payment?.wallet?.url} passHref legacyBehavior>
                {checkDevice() == "Android" ? (
                  <a
                    ...
                    className="btn bg-[#753C94] btn-rounded w-full flex items-center font-Axiata-Medium"
                  >
                    Buka Aplikasi Gojek
                  </a>
                ) : (
