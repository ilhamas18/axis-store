...
import { dataOVO } from "@components/data";
import { openA, prependZero } from "@components/global/mixins";
import { Button } from "@components/templates/button/button";
import { useSelector, shallowEqual } from "react-redux";
import { State } from "store/reducer";
import { priceNumber, checkDateSecond } from "@components/global/mixins";
...
const EwalletEsim = () => {
  ...
  return (
    <div className="container">
      <SEO title={"Pembayaran Esim E-Wallet OVO"} />
      <Snackbar
      ...
      <div className="body pb-6">
          ...
          <div className="text-center shadow-card px-4 font-Museo">
            ...
            <div className="space-y-3 font-Museo md:text-sm text-sm">
              ...
              <div className="list-info">
                ...
                <div className="list-value">OVO</div>
              </div>
              <div className="list-info">
        ...
        <div className="px-4">
          <div className="py-3">
            <h3 className="font-Museo-Bold">Cara bayar dengan aplikasi OVO </h3>
          </div>
          <StepList title={"Cara Bayar"}>
            {dataOVO.map((item: any, index: number) => (
              <div
          ...
          <div className="py-6 flex flex-row items-start justify-center rounded-[12px]">
            ...
            <div className="w-[90%]">
              <div className="font-Museo md:text-sm tracking-wider text-xs text-slate-500">
                Pastikan transaksi OVO Anda sudah terverifikasi sebelum
