...
import { dataAtmBri, dataMbBri, dataIbBri } from "@components/data";
...
const VirtualAccountEsim = () => {
  ...
  return (
    <div className="container">
      <SEO title={"Pembayaran Esim Virtual Account BRI"} />
      {/* <iframe
      ...
      <div className="body pb-6">
          ...
          <div className="text-center shadow-card px-4 font-Museo">
            ...
            <div className="space-y-3 font-Museo md:text-sm text-sm">
              ...
              <div className="list-info">
                ...
                <div className="list-value">Virtual Account BRI</div>
              </div>
              <div className="list-info">
            ...
            <div className="card-payment-info font-Museo md:text-md text-sm flex justify-between w-full items-center">
              <div className="content">
                ...
                <div className="ml-5 text-md w-3/4">
                  ...
                  <span className="text-sm">Virtual Account BRI</span>
                </div>
              </div>
        ...
        <div className="px-4">
          ...
          <StepList title={"ATM"}>
            {dataAtmBri.map((item: any, index: number) => (
              <div
          ...
          <StepList title={"Mobile Banking"}>
            {dataMbBri.map((item: any, index: number) => (
              <div
                className="p-2 rounded-lg flex font-Museo text-sm items-center"
                key={index}
              >
          ...
          <StepList title={"Internet Banking"}>
            {dataIbBri.map((item: any, index: number) => (
              <div
                className="p-2 rounded-lg flex font-Museo text-sm items-center"
                key={index}
              >
