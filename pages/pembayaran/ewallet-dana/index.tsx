...
import { dataDANA } from "@components/data";
...
const WalletAccount = () => {
  ...
  const CancelReserveSync = async () => {
    ...
    if (reserve.status == 200) {
      router.push("/pembayaran/ewallet-dana/timeout");
  ...
  const openUrl = () => {
    if (checkDevice() == "Browser") {
      openA(payment?.wallet?.url_desktop);
    } else {
      openA(payment?.wallet?.url_mobile);
    }
  };
  ...
  }, [payment?.wallet?.url_desktop, payment?.wallet?.url_mobile]);
  ...
  return (
    <div className="container">
      <SEO title={"Pembayaran E-Wallet DANA"} />
      ...
      <div className="body pb-6">
        <div className="px-4 border-b-2 border-light-gray">
          ...
          <div className="text-center shadow-card px-4 font-Museo">
            ...
            <div className="list-info">
              ...
              <div className="list-value">DANA</div>
            </div>
            <div className="list-info">
          ...
          <div className="py-6 my-8 px-4 my-6 bg-light-blue flex flex-row items-center justify-center rounded-[12px] my-2">
            <div className="w-[10%]">
          ...
          <div className="py-3 hidden">
            ...
            >
              <div className="flex justify-center items-center font-Museo-Medium">
                <span className="button-text">Buka Aplikasi Dana</span>
              </div>
            </Button>
          </div>
        </div>
        <div className="px-4">
          <div className="py-3">
            <h3 className="font-Museo-Bold">
              Cara bayar dengan aplikasi DANA{" "}
            </h3>
          </div>
          <StepList title={"Cara Bayar"}>
            {dataDANA.map((item: any, index: number) => (
              <div
          ...
          <div className="py-6 flex flex-row items-start justify-center rounded-[12px]">
            ...
            <div className="w-[90%]">
              <div className="font-Museo md:text-sm tracking-wider text-xs text-slate-500">
                Pastikan transaksi DANA Anda sudah terverifikasi sebelum
