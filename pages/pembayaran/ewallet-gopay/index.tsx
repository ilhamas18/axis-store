...
import { dataGopay } from "@components/data";
...
const WalletAccount = () => {
  ...
  const CancelReserveSync = async () => {
    ...
    if (reserve.status == 200) {
      router.push("/pembayaran/ewallet-gopay/timeout");
  ...
  return (
    <div className="container">
      <SEO title={"Pembayaran E-Wallet Gopay"} />
      ...
      <div className="body pb-6">
        <div className="px-4 border-b-2 border-light-gray">
          ...
          <div className="text-center shadow-card px-4 font-Museo">
            ...
            <div className="list-info">
              ...
              <div className="list-value">Gopay</div>
            </div>
            <div className="list-info">
          ...
          {checkDevice() == "Browser" && (
            <div className="py-5">
              <div className="card-payment-info flex flex-col justify-center items-center">
                <h3 className="leading-5 text-center mb-3">
                  Buka aplikasi Gojek dan scan QR Code dibawah ini.
                </h3>
                <Image src={payment.wallet.qr_code} width={200} height={200} alt="QR Code" />
              </div>
            </div>
          )}
          ...
          {checkDevice() != "Browser" && (
            <div className="py-3">
              <Link href={payment?.wallet?.url} passHref legacyBehavior>
                {checkDevice() == "Android" ? (
                  <a
                    target="_blank"
                    rel="noopener noreferrer"
                    className="btn bg-[#753C94] btn-rounded w-full flex items-center font-Museo-Medium"
                  >
                    Buka Aplikasi Gojek
                  </a>
                ) : (
          ...
          <div className="py-3 hidden">
            ...
            >
              <div className="flex justify-center items-center font-Museo-Medium">
                <span className="button-text">Buka Aplikasi Gojek</span>
              </div>
            </Button>
          </div>
        </div>
        <div className="px-4">
          <div className="py-3">
            <h3 className="font-Museo-Bold">Cara bayar dengan Gopay </h3>
          </div>
          <StepList title={"Cara Bayar"}>
            {dataGopay.map((item: any, index: number) => (
              <div
          ...
          <div className="py-6 flex flex-row items-start justify-center rounded-[12px]">
            ...
            <div className="w-[90%]">
              <div className="font-Museo md:text-sm tracking-wider text-xs text-slate-500">
                Pastikan transaksi Gopay Anda sudah terverifikasi sebelum
