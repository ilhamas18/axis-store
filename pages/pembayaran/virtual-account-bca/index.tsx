...
const VirtualAccount = () => {
  ...
  return (
    <div className="container">
      <SEO title={"Pembayaran Virtual Account BCA"} />
      <iframe
        src="https://9562726.fls.doubleclick.net/activityi;src=9562726;type=xlweb0;cat=dan_x003;dc_lat=;dc_rdid=;tag_for_child_directed_treatment=;tfua=;npa=;gdpr=${GDPR};gdpr_consent=${GDPR_CONSENT_755};ord=[SessionID]?"
        width="1"
        height="1"
        frameBorder="0"
        style={{ display: "none" }}
      ...
      <div className="body pb-6">
        <div className="px-4 border-b-2 border-light-gray">
          ...
          <div className="text-center shadow-card px-4 font-Museo">
            ...
            <div className="list-info">
              ...
              <div className="list-value">Virtual Account BCA</div>
            </div>
            <div className="list-info">
        ...
        <div className="px-4">
          ...
          <StepList title={"ATM"}>
            {dataAtmBca.map((item: any, index: number) => (
              <div
          ...
          <StepList title={"Mobile Banking"}>
            {dataMbBca.map((item: any, index: number) => (
              <div
                className="p-2 rounded-lg flex font-Museo text-sm items-center"
                key={index}
              >
          ...
          <div className="py-6 flex flex-row items-start justify-center rounded-[12px]">
            ...
            <div className="w-[90%]">
              <div className="font-Museo md:text-sm tracking-wider text-xs text-slate-500">
                Pastikan transaksi BCA Virtual Account Anda sudah terverifikasi
