...
const Status = () => {
  ...
  return (
    <div className="container">
      <SEO title={"Status Terima"} />
      <iframe
        src="https://9562726.fls.doubleclick.net/activityi;src=9562726;type=xlweb0;cat=dan_x008;dc_lat=;dc_rdid=;tag_for_child_directed_treatment=;tfua=;npa=;gdpr=${GDPR};gdpr_consent=${GDPR_CONSENT_755};ord=1;num=1?"
        width="1"
        height="1"
        frameBorder="0"
        style={{ display: "none" }}
      ...
      <div className="body pb-6">
        <div className="px-4 border-b-4 border-light-gray">
          ...
          <div className="text-center shadow-card px-4 font-Museo">
            <div className="py-5">
              <h3 className="text-xl font-Museo-Bold">Pesanan Diterima</h3>
            </div>
            <hr />
